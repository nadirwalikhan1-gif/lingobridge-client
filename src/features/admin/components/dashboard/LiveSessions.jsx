...
const MOCK_SESSIONS = [
  {
    id: 1,
    interpreterInitials: 'MG',
    interpreterName: 'Maria Gonzalez',
    fromLang: 'Spanish',
    toLang: 'English',
    category: 'Medical',
    type: 'video',
  ...
  {
    id: 2,
    interpreterInitials: 'AK',
    interpreterName: 'Ali Khan',
    fromLang: 'Urdu',
    toLang: 'English',
    category: 'Legal',
    type: 'audio',
  ...
  {
    id: 3,
    interpreterInitials: 'SC',
    interpreterName: 'Sarah Chen',
    fromLang: 'Mandarin',
    toLang: 'English',
    category: 'Emergency',
    type: 'video',
    client: 'ICU Team',
    note: 'Patient unresponsive · Room 4',
    startedSecsAgo: 2 * 60 + 14,
    status: 'escalated',
  },
  {
    id: 4,
    interpreterInitials: 'JR',
    interpreterName: 'Jamal Rahimi',
    fromLang: 'Dari',
    toLang: 'English',
