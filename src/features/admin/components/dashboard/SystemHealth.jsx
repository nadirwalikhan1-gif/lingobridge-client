  ...
  return (
    <div className="lb-card">
      <div className="flex items-center justify-between px-4 py-3 border-b border-lb-border">
        <span className="lb-section-title">Operations Health</span>
      ...
      {metrics.length === 0 ? (
        ...
        <p className="text-[13px] font-medium text-lb-ink">No metrics</p>
        <p className="text-[11px] text-lb-muted">Health metrics unavailable</p>
      </div>
      ) : (
            ...
            return (
              <div key={m.label} className="px-4 py-2.5 flex items-center gap-3">
                <div className="w-[160px] shrink-0">
                  <p className="text-[12px] font-medium text-lb-ink leading-none mb-0.5">{m.label}</p>
