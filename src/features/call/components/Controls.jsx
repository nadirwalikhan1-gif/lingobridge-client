  ...
  return (
    <div className="flex items-center justify-center gap-4 py-4">
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <span className={`text-[10px] ${micMuted ? 'text-[#F09595]' : 'text-white/40'}`}>
      ...
      {isVideo && (
        <div className="flex flex-col items-center gap-1">
          ...
          <span className={`text-[10px] ${camOff ? 'text-[#F09595]' : 'text-white/40'}`}>
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <span className={`text-[10px] ${chatOpen ? 'text-[#AFA9EC]' : 'text-white/40'}`}>
