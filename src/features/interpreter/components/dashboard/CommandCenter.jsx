    ...
    <div className="lb-card !p-0 overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-lb-border">
        ...
        <div className="bg-white p-4 flex flex-col justify-between">
          <div className="flex items-center gap-2 mb-1">
            ...
            />
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-lb-muted">Status</span>
          </div>
          <p className="text-[20px] font-bold text-lb-ink leading-none">{meta.label}</p>
        ...
        <div className="bg-white p-4 flex flex-col justify-between">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-lb-muted">Call queue</span>
          </div>
        ...
        <div className="bg-white p-4 flex flex-col justify-between">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-lb-muted">Acceptance</span>
          </div>
          <div className="flex items-baseline gap-1.5">
        ...
        <div className="bg-white p-4 flex flex-col justify-between">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-[11px] font-semibold uppercase tracking-[0.08em] text-lb-muted">Avg rating</span>
          </div>
          <div className="flex items-baseline gap-1.5">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-lb-border border-t border-lb-border">
        ...
        <div className="bg-[#1a1635] p-4 flex flex-col justify-between">
          <span className="text-[11px] font-semibold text-white/50 uppercase tracking-[0.08em]">Today's earnings</span>
          <div>
            <p className="text-[24px] font-bold text-white leading-none mt-1 lb-stat-num">
        ...
        <div className="bg-white p-4 flex flex-col justify-between">
          <span className="text-[11px] font-semibold text-lb-muted uppercase tracking-[0.08em]">Sessions today</span>
          <div>
            <p className="text-[24px] font-bold text-lb-ink leading-none mt-1 lb-stat-num">
        ...
        <div className="bg-white p-4 flex flex-col justify-between">
          <span className="text-[11px] font-semibold text-lb-muted uppercase tracking-[0.08em]">Hours today</span>
          <div>
            <p className="text-[24px] font-bold text-lb-ink leading-none mt-1 lb-stat-num">
              {display(hoursToday)}
            </p>
